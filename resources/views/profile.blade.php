    ...
    <section class="blog-area section">
        <div class="container">
            ...
            <div class="row">
                                    ...
                                    <div class="single-post post-style-1">
                                        ...
                                        <div class="blog-info">
                                            ...
                                            <ul class="post-footer">
                                                ...
                                                <li>
                                                    ...
                                                    @else
                                                        <a href="javascript:void(0);" onclick="document.getElementById('favorite-form-{{ $post->id }}').submit();"
                                                           class="{{ !Auth::user()->favourite_post->where('pivot.post_id',$post->id)->count()  == 0 ? 'favorite_posts' : ''}}"><ion-icon  name="heart-sharp"></ion-icon>{{ $post->favourite_user->count() }}</a>
                                                ...
                                                <li>
                                                    <a href="#"><ion-icon name="chatbubble-sharp"></ion-icon>{{ $post->comments->count() }}</a>
                                                </li>
                                                <li>
                                                    <a href="#"><ion-icon name="eye-sharp"></ion-icon>{{ $post->view_count }}</a>
                                                </li>
                                            </ul>
                ...
                <div class="col-lg-4 col-md-12 " style="height:70%;">

                    <div class="single-post info-area ">

                        <div class="about-area">
                            <h4 class="title"><b>ABOUT AUTHOR</b></h4>
                            <p>Name: {{ $author->name }}</p><br>
