                    ...
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="email_address" name="title" class="form-control" placeholder="Enter title">
                                    </div>
                                </div>
                        ...
                        <div class="body">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <select name="categories[]" id="category" class="form-control show-tick" multiple >
                                        ...
                                        <option value="{{$category->id}}" style="padding-left:10px">{{$category->category_name}}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <option value="">select</option>
                                        @foreach($tag as $tag)
                                        <option value="{{$tag->id}}" style="padding-left:10px">{{$tag->tag_name}}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                </div>
